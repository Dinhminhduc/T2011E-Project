                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-sm">
                        <div>
                            ...
                            <small class="text-muted">All Product Free</small>
                        </div>
...
{{--                        <button type="submit" class="btn btn-secondary" style="margin-left: 5px">Redeem</button>--}}
{{--                    </div>--}}
{{--                </form>--}}
            </div>
            <div class="col-md-7 col-lg-8">
                <h4 class="mb-3">Billing address</h4>
                <form class="needs-validation" novalidate action="{{route('place_order_product')}}" method="post">
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6">
